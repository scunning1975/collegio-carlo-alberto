...
\vspace*{2em} % Adjust this for more vertical spacing at the top
\begin{center}
    {\Huge\textbf{\textcolor{navy}{University of Glasgow \\ \bigskip 2025}}}
    
    \vspace{2em} % Increase this space to push the image further down
    \includegraphics[width=0.9\linewidth]{./lecture_includes/banner_cropped} % Adjust width to improve horizontal balance
\end{center}
